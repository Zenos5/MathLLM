...
if __name__ == "__main__":
    ...
    predictor.setup(model_base=None, model_name="./ckpt/pretrained_ckpt/llemma_ckpt/", model_path="./ckpt/delta_ckpt/nextgpt/7b_tiva_v0/", load_8bit=False, load_4bit=False)
